...
const rankingQuery = "select a.asistencia_id,a.asistencia,a.clase_id,a.usuario_id,c.instructor_id,c.actividad_id,c.fecha_hora,c.duracion,act.nombre as nombre_actividad,act.descripcion as descripcion_actividad,act.pictureURL as pictureURL_actividad,uu.nombre as nombre_usuario,uu.apellidos as apellidos_usuario, uu.pictureURL as pictureURL_usuario,uu.nacionalidad,nac.codigo_iso,nac.nombre as pais_nombre,a.cinturon,a.grado, COUNT(a.asistencia_id) AS total_asistencias from asistencias a LEFT JOIN clases c on a.clase_id=c.clase_id LEFT JOIN actividades act on c.actividad_id=act.actividad_id  LEFT JOIN usuarios uu on uu.id=a.usuario_id LEFT JOIN nacionalidades nac on nac.id=uu.nacionalidad where a.asistencia=1 GROUP BY a.usuario_id order by total_asistencias desc";
